...
<div class="container">
    ...
    <?php if ($this->session->userdata('LEVEL') == 'admin'){ ?>
        <div class="navbar hidden-print" style="border: 2px solid #292727">
            <div class="navbar-inner" >
                <div class="container" >
                    <ul class="nav">
                        <li class="<?php if(isset($active_dashboard)){echo $active_dashboard ;}?>">
                            <a href="<?php echo site_url('dashboard')?>"><i class="icon-home" style="border: 2px solid #292727"></i> Dashboard</a>
                        </li>
                        <li class="<?php if(isset($active_penjualan)){echo $active_penjualan ;}?>">
                            <a href="<?php echo site_url('penjualan')?>"><i class="icon-shopping-cart" style="border: 2px solid #292727"></i> Penjualan</a>
                        </li>
                        <li class="<?php if(isset($active_laporan)){echo $active_laporan ;}?>">
                            <a href="<?php echo site_url('laporan')?>"><i class="icon-tasks" style="border: 2px solid #292727"></i> Laporan</a>
                        </li>
                        <li class="<?php if(isset($active_master)){echo $active_master ;}?>">
                            <a href="<?php echo site_url('master')?>"><i class="icon-folder-open"></i> Data Toko</a>
                        </li>
            ...
            <div class="container">
                <ul class="nav">
                    <li class="<?php if(isset($active_dashboard)){echo $active_dashboard ;}?>">
					 ...
					 <li class="<?php if(isset($active_promo)){echo $active_promo ;}?>">
                        <a href="<?php echo site_url('promo')?>"><i class="icon-list-alt" ></i>  Promo perhari ini</a>
                    </li>
                    <li class="<?php if(isset($active_penjualan)){echo $active_penjualan ;}?>">
                        <a href="<?php echo site_url('penjualan')?>"><i class="icon-shopping-cart" style="border: 2px solid #292727"></i>  Penjualan</a>
                    </li>
