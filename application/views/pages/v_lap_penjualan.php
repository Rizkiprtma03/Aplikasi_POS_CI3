...
<h3 style="text-align: center">
    Lihat Laporan Penjualan Berdasarkan Tanggal Yang di Pilih
</h3>
<div class="container-fluid">
    ...
    <div class="row-fluid">
        <div id="laporanPage">
			...
			<div>
			 <button type="submit" class="btn btn-success" onClick="document.location.reload(true)" style="margin-left: 189px"><i class="icon icon-white icon-search"></i> refresh</button>
			</div>
        </div>
    </div>
    <div style="border-bottom: 1px #999 dashed; margin-bottom: 20px"></div>
