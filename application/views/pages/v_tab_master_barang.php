<table class="table table-bordered table-striped">
    ...
    <tr>
        ...
        <th>Harga</th>
        <th class="span2">
			<a class="btn btn-success" href="<?php echo base_url('master/export_excel')?>">Download File Excel</a>
            <a style="width: 164px; height: 26px; font-size: 12px" href="#modalAddBarang" class="btn btn-mini btn-block btn-inverse" data-toggle="modal"><i class="icon-plus-sign icon-white"></i> Tambah Data </a>
        </th>
    </tr>
    </thead>
    <tbody>
    ...
    <tr>
        ...
        <td>
            <a style="height:20px; width: 50px;" class="btn btn-mini" href="#modalEditBarang<?php echo $row->kd_barang?>" data-toggle="modal"><i class="icon-pencil"></i> Edit</a>
            <a style="height:20px; width: 50px;" class="btn btn-mini" href="<?php echo site_url('master/hapus_barang/'.$row->kd_barang);?>"
